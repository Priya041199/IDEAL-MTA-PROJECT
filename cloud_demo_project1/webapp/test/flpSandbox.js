		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comibsplclouddemoproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsplclouddemoproject1-display": {
								"semanticObject": "comibsplclouddemoproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibspl.clouddemoproject1",
									"url": sap.ui.require.toUrl("com/ibspl/clouddemoproject1")
								}
							}
						}
					}
