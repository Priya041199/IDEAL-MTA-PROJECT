		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comibsibsappidealsystemconfiguration-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealsystemconfiguration-display": {
								"semanticObject": "comibsibsappidealsystemconfiguration",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealsystemconfiguration",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealsystemconfiguration")
								}
							}
						}
					}
