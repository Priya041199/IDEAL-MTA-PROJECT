		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comibsibsappidealregistrationform-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealregistrationform-display": {
								"semanticObject": "comibsibsappidealregistrationform",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealregistrationform",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealregistrationform")
								}
							}
						}
					}
