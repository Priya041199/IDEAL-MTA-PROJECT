		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comibsibsappidealregistrationapproval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealregistrationapproval-display": {
								"semanticObject": "comibsibsappidealregistrationapproval",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealregistrationapproval",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealregistrationapproval")
								}
							}
						}
					}
