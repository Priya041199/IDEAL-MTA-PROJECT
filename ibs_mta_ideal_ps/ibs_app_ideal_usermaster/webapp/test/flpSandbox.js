		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "User Master",
									"targetURL": "#comibsibsappidealusermaster-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealusermaster-display": {
								"semanticObject": "comibsibsappidealusermaster",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealusermaster",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealusermaster")
								}
							}
						}
					}
