sap.ui.define(
    ...
    //   "sap/ui/core/mvc/Controller",
      ...
      "sap/m/MessageBox",
      "/sap/m/MessageToast",
      "com/ibs/ibsappidealclaimapproval/model/down"
    ],
    function(BaseController,JSONModel,formatter,BusyIndicator,MessageBox,MessageToast,down) {
      "use strict";
      var that;
      var myJSONModel12;
      var userData;
      ...
      var level;
      var sUserRole;
      return BaseController.extend("com.ibs.ibsappidealclaimapproval.controller.DetailPage", {
        formatter: formatter,
        onInit: function() {
        //   debugger;
          that = this;
        ...
        readUserMasterEntities: async function () {
            ...
            that.checkUserId(crNo, userData.userId)
        },
        checkUserId : function(crNo,userId){
			// debugger;
...
onZoomOut: function () {
    ...
    onApprove: function (oEvent) {
        if (!this.filterfrag) {
            this.filterfrag = sap.ui.xmlfragment("com.ibspl.ideal.idealclaimapproval.view.fragments.approveFrag", this);
        }
        ...
        sap.ui.getCore().byId("id_sendbackBt").setVisible(false);
    ...
    commonRequestAction: function (oAction) {
        ...
        if(oAction === "APPROVE"){
            var comm = "Claim request approved"
            var eventRemark = "Claim request Approved"
        }else{
            var comm = sap.ui.getCore().byId("id_comment").getValue();
            var eventRemark = "Claim request Rejected"
        }
        ...
        var headerPaylod = [{
            ...
            "DISTRIBUTOR_NAME" : approvalData.DISTRIBUTOR_NAME,
            "CLAIM_TYPE":approvalData.CLAIM_TYPE,
            "CLAIM_DESC":approvalData.CLAIM_DESC,
    ...
    onSendBack: function(){
        ...
        sap.ui.getCore().byId("id_approve").setVisible(false);
        sap.ui.getCore().byId("id_reject").setVisible(false);
        sap.ui.getCore().byId("id_sendbackBt").setVisible(true);
        sap.ui.getCore().byId("id_back").setVisible(false);
        sap.ui.getCore().byId("id_lable").setRequired(true);
        sap.ui.getCore().byId("idApproveDialog").setTitle("Do you want to Sendback ?");
    },
    onSubmitSendback: function () {
        var commentVal = sap.ui.getCore().byId("id_comment");
