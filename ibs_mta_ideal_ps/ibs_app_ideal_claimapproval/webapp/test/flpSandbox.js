		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comibsibsappidealclaimapproval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealclaimapproval-display": {
								"semanticObject": "comibsibsappidealclaimapproval",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealclaimapproval",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealclaimapproval")
								}
							}
						}
					}
