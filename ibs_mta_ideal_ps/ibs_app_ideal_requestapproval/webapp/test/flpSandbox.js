		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comibsibsappidealrequestapproval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealrequestapproval-display": {
								"semanticObject": "comibsibsappidealrequestapproval",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealrequestapproval",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealrequestapproval")
								}
							}
						}
					}
