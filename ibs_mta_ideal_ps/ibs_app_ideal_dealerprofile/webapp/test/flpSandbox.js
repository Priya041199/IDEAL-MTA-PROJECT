		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comibsibsappidealdealerprofile-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealdealerprofile-display": {
								"semanticObject": "comibsibsappidealdealerprofile",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealdealerprofile",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealdealerprofile")
								}
							}
						}
					}
