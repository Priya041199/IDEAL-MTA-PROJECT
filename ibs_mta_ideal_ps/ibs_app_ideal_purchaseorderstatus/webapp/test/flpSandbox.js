		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comibsibsappidealpurchaseorderstatus-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealpurchaseorderstatus-display": {
								"semanticObject": "comibsibsappidealpurchaseorderstatus",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealpurchaseorderstatus",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealpurchaseorderstatus")
								}
							}
						}
					}
