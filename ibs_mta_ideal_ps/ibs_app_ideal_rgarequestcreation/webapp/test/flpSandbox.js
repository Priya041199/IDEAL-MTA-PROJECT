		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "RGA Creation",
									"targetURL": "#comibsibsappidealrgarequestcreation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealrgarequestcreation-display": {
								"semanticObject": "comibsibsappidealrgarequestcreation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealrgarequestcreation",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealrgarequestcreation")
								}
							}
						}
					}
