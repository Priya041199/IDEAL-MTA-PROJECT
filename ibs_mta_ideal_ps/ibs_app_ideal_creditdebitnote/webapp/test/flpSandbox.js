		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comibsibsappidealcreditdebitnote-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealcreditdebitnote-display": {
								"semanticObject": "comibsibsappidealcreditdebitnote",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealcreditdebitnote",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealcreditdebitnote")
								}
							}
						}
					}
