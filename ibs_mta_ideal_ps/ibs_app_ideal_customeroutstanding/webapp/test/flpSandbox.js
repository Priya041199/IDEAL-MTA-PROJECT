		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comibsibsappidealcustomeroutstanding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealcustomeroutstanding-display": {
								"semanticObject": "comibsibsappidealcustomeroutstanding",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealcustomeroutstanding",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealcustomeroutstanding")
								}
							}
						}
					}
