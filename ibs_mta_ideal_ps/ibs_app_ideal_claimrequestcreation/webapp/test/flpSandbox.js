		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Claim Request Creation",
									"targetURL": "#comibsibsappidealclaimrequestcreation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealclaimrequestcreation-display": {
								"semanticObject": "comibsibsappidealclaimrequestcreation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealclaimrequestcreation",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealclaimrequestcreation")
								}
							}
						}
					}
