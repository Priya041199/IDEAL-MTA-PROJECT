		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Error Log",
									"targetURL": "#comibsibsappidealerrorlog-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealerrorlog-display": {
								"semanticObject": "comibsibsappidealerrorlog",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealerrorlog",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealerrorlog")
								}
							}
						}
					}
