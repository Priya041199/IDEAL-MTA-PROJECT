		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "RGA Approval",
									"targetURL": "#comibsibsappidealrgaapproval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealrgaapproval-display": {
								"semanticObject": "comibsibsappidealrgaapproval",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealrgaapproval",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealrgaapproval")
								}
							}
						}
					}
