		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comibsplonpremiseproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsplonpremiseproject1-display": {
								"semanticObject": "comibsplonpremiseproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibspl.onpremiseproject1",
									"url": sap.ui.require.toUrl("com/ibspl/onpremiseproject1")
								}
							}
						}
					}
