		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comibsplclouddemoproject3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsplclouddemoproject3-display": {
								"semanticObject": "comibsplclouddemoproject3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibspl.clouddemoproject3",
									"url": sap.ui.require.toUrl("com/ibspl/clouddemoproject3")
								}
							}
						}
					}
