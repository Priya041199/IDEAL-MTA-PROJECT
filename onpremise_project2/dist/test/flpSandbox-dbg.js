		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comibsplonpremiseproject2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsplonpremiseproject2-display": {
								"semanticObject": "comibsplonpremiseproject2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibspl.onpremiseproject2",
									"url": sap.ui.require.toUrl("com/ibspl/onpremiseproject2")
								}
							}
						}
					}
