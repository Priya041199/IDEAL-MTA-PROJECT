		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comibsplclouddemoproject2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsplclouddemoproject2-display": {
								"semanticObject": "comibsplclouddemoproject2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibspl.clouddemoproject2",
									"url": sap.ui.require.toUrl("com/ibspl/clouddemoproject2")
								}
							}
						}
					}
