		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comibsplonpremiseproject3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsplonpremiseproject3-display": {
								"semanticObject": "comibsplonpremiseproject3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibspl.onpremiseproject3",
									"url": sap.ui.require.toUrl("com/ibspl/onpremiseproject3")
								}
							}
						}
					}
