		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comibsplpracticeproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsplpracticeproject-display": {
								"semanticObject": "comibsplpracticeproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibspl.practiceproject",
									"url": sap.ui.require.toUrl("com/ibspl/practiceproject")
								}
							}
						}
					}
