		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comibsplonpremisedemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsplonpremisedemo-display": {
								"semanticObject": "comibsplonpremisedemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibspl.onpremisedemo",
									"url": sap.ui.require.toUrl("com/ibspl/onpremisedemo")
								}
							}
						}
					}
